import { R as React, r as react, i as index$1, a as init, j as jsx, b as jsxs, S as Style, c as config, P as Participants, D as DeviceSelection, C as ControlPanel, d as Chat, e as ReactDOM, u as url, A as AppProvider } from "./index.0b30e1d5.js";
...
const Project = () => {
  ...
  const [selectedVideo, setSelectedVideo] = react.exports.useState(null);
  const [selectedImage, setSelectedImage] = react.exports.useState(null);
  const [banners, setBanners] = React.useState(studio.compositor.getSources("Banner"));
  const [loop, setLoop] = react.exports.useState(true);
  react.exports.useState(false);
  const layout = project.props.layout;
  const background = projectCommands.getBackgroundMedia();
  projectCommands.getImageOverlay();
  const overlays = [{
    id: "123",
      ...
      children: [/* @__PURE__ */ jsx("label", {
        ...
        children: [/* @__PURE__ */ jsx("div", {
          children: /* @__PURE__ */ jsxs("span", {
            children: ["Overlays", /* @__PURE__ */ jsx("ul", {
              style: {
                listStyle: "none"
              },
              children: overlays.map((overlay2) => /* @__PURE__ */ jsx("li", {
                onClick: () => {
                  setSelectedImage(overlay2.id);
                  projectCommands.addImageOverlay(overlay2.id, {
                    src: overlay2.url
                  });
                },
          ...
          children: /* @__PURE__ */ jsxs("span", {
            children: ["Video clips", /* @__PURE__ */ jsx("ul", {
              style: {
                listStyle: "none"
              },
              children: videooverlays.map((overlay2) => /* @__PURE__ */ jsxs("li", {
                onClick: () => {
                  setSelectedVideo(overlay2.id);
                  projectCommands.addVideoOverlay(overlay2.id, {
                    src: overlay2.url,
                    loop: true
                  });
                },
                children: [/* @__PURE__ */ jsx("input", {
                  ...
                  onClick: (e2) => {
                    e2.stopPropagation();
                    projectCommands.updateVideoOverlayProps(overlay2.id, {
                      loop: !loop
                    });
                    setLoop(!loop);
                  },
          ...
          children: /* @__PURE__ */ jsxs("span", {
            children: ["Logos", /* @__PURE__ */ jsxs("ul", {
              style: {
                listStyle: "none"
              },
              children: [logos.map((logo) => /* @__PURE__ */ jsx("li", {
                onClick: () => {
      ...
      children: [/* @__PURE__ */ jsx(Participants, {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx("label", {
            ...
            onChange: (e2) => {
              if (/\.(gif|jpe?g|tiff?|png|webp|bmp)$/i.test(e2.target.value)) {
...
//# sourceMappingURL=main.00477a95.js.map
