import { R as React, r as react, i as index$1, a as init, j as jsx, b as jsxs, S as Style, c as config, P as Participants, D as DeviceSelection, C as ControlPanel, d as Chat, e as ReactDOM, u as url, A as AppProvider } from "./index.400da1b2.js";
        ...
        children: [/* @__PURE__ */ jsx("div", {
          children: /* @__PURE__ */ jsxs("span", {
            children: ["Overlays", /* @__PURE__ */ jsx("ul", {
              ...
              children: overlays.map((overlay2) => /* @__PURE__ */ jsx("li", {
                onClick: () => {
                  if (selectedImage !== overlay2.id) {
                    setSelectedImage(overlay2.id);
                    projectCommands.addImageOverlay2(overlay2.id, {
                      src: overlay2.url
                    });
                  } else {
          ...
          children: /* @__PURE__ */ jsxs("span", {
            children: ["Video clips", /* @__PURE__ */ jsx("ul", {
              ...
              children: videooverlays.map((overlay2) => /* @__PURE__ */ jsx("li", {
                onClick: () => {
                  if (selectedVideo !== overlay2.id) {
                    setSelectedVideo(overlay2.id);
                    projectCommands.addVideoOverlay2(overlay2.id, {
                      src: overlay2.url,
                      loop: true
                    });
                  } else {
          ...
          children: /* @__PURE__ */ jsxs("span", {
            children: ["Logos", /* @__PURE__ */ jsx("ul", {
              style: {
                listStyle: "none"
              },
          ...
          children: [/* @__PURE__ */ jsx("label", {
            ...
            onChange: (e2) => {
              if (/\.(gif|jpe?g|tiff?|png|webp|bmp)$/i.test(e2.target.value)) {
                ...
                projectCommands.setBackgroundVideo(e2.target.value);
              }
            }
          })]
        }), /* @__PURE__ */ jsxs("div", {
...
//# sourceMappingURL=main.8e324ff0.js.map
