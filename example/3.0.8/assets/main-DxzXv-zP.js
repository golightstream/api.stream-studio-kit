import { r as reactDomExports, g as getDefaultExportFromCjs, R as React, a as reactExports, j as jsx, i as index$1, b as init, c as jsxs, S as Style$1, d as config, P as Participants, D as DeviceSelection, C as ControlPanel, e as Chat, u as url, A as AppProvider } from "./index-BeVUOGS4.js";
var createRoot;
...
const Login = (props) => {
  ...
  const [userName, setUserName] = reactExports.useState(storage.userName);
  const [recaptchaToken, setRecaptchaToken] = reactExports.useState();
...
const Project = () => {
  ...
  const [sources, setSources] = reactExports.useState(project.sources);
  ...
  const [rtmpUrl, setRtmpUrl] = reactExports.useState(destinationAddress == null ? void 0 : destinationAddress.url);
  const [streamKey, setStreamKey] = reactExports.useState(destinationAddress == null ? void 0 : destinationAddress.key);
  const [previewUrl, setPreviewUrl] = reactExports.useState("");
  const [guestUrl, setGuestUrl] = reactExports.useState("");
  ...
  const [background, setBackground] = reactExports.useState(projectCommands.getBackgroundMedia());
  const [logo, setLogo] = reactExports.useState(projectCommands.getLogo());
  const [overlay, setOverlay] = reactExports.useState(projectCommands.getImageOverlay());
  const [videoOverlay, setVideoOverlay] = reactExports.useState(projectCommands.getVideoOverlay());
  React.useEffect(() => {
    return project.subscribe((event, payload) => {
      ...
      if (event === "ProjectSourceAdded") {
        ...
        if (((_b = (_a = source.address) == null ? void 0 : _a.dynamic) == null ? void 0 : _b.id) === "console-integration") {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx(MediaHeader, {
            ...
            children: /* @__PURE__ */ jsx("input", {
              ...
              onClick: (e2) => {
                projectCommands.createSource({
                  displayName: `RTMP source: ${Math.ceil(Math.random() * 1e4)}`,
                  address: {
                    rtmpPush: {
                      enabled: true
                    }
            ...
            className: Style$1.column,
            children: sources.filter((source) => !source.address.dynamic).map((source) => {
              var _a, _b;
              return /* @__PURE__ */ jsxs("div", {
                children: [/* @__PURE__ */ jsxs("div", {
                  children: ["id: ", source.id, ", participantId:", " ", (_b = (_a = source.preview) == null ? void 0 : _a.webrtc) == null ? void 0 : _b.participantId]
                }), /* @__PURE__ */ jsxs("div", {
                  children: ["url: ", source.address.rtmpPush.baseUrl, " key:", " ", source.address.rtmpPush.key]
                }), /* @__PURE__ */ jsx("input", {
                  type: "button",
                  value: "Delete",
                  onClick: (e2) => {
          ...
          children: [/* @__PURE__ */ jsx(MediaHeader, {
            ...
            children: /* @__PURE__ */ jsx("input", {
              ...
              onClick: (e2) => {
                projectCommands.createGameSource({
                  displayName: `Game source: ${Math.ceil(Math.random() * 1e4)}`,
                  address: {
                    dynamic: {
            ...
            className: Style$1.column,
            children: sources.filter((source) => {
              var _a, _b;
              return ((_b = (_a = source.address) == null ? void 0 : _a.dynamic) == null ? void 0 : _b.id) === "console-integration";
            }).map((source) => {
              var _a, _b, _c, _d;
              return /* @__PURE__ */ jsxs("div", {
                children: [/* @__PURE__ */ jsxs("div", {
                  ...
                  children: ["url: ", (_d = (_c = source.address) == null ? void 0 : _c.rtmpPull) == null ? void 0 : _d.url]
                }), /* @__PURE__ */ jsx("input", {
                  type: "button",
                  value: "Delete",
                  onClick: (e2) => {
...
const HostView = () => {
  ...
  const [token, setToken] = reactExports.useState(localStorage["token"]);
...
document.addEventListener("DOMContentLoaded", function(event) {
  if (!container) {
    ...
    root.render(/* @__PURE__ */ jsx(Content, {}));
  }
});
const Content = () => {
  return /* @__PURE__ */ jsxs("div", {
...
//# sourceMappingURL=main-DxzXv-zP.js.map
