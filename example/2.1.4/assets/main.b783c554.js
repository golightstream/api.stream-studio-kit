import { R as React, r as react, j as jsx, i as index$1, a as init, b as jsxs, S as Style$1, c as config, P as Participants, D as DeviceSelection, C as ControlPanel, d as Chat, e as ReactDOM, u as url, A as AppProvider } from "./index.89ad31e7.js";
...
const Project = () => {
  ...
  const [sources, setSources] = react.exports.useState(project.sources);
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx(MediaHeader, {
            ...
            children: sources.map((source2) => {
              ...
              return /* @__PURE__ */ jsxs("div", {
                children: [/* @__PURE__ */ jsxs("div", {
                  children: ["id: ", source2.id, ", participantId: ", (_b = (_a = source2.preview) == null ? void 0 : _a.webrtc) == null ? void 0 : _b.participantId]
                }), /* @__PURE__ */ jsxs("div", {
                  children: ["url: ", source2.address.rtmpPush.baseUrl, "   key: ", source2.address.rtmpPush.key]
                }), /* @__PURE__ */ jsx("input", {
                  type: "button",
                  value: "Delete",
                  onClick: (e2) => {
                  ...
                  value: "Add to stream",
                  onClick: (e2) => {
                    projectCommands.addRTMPSource(source2.id, {});
                  }
                }), /* @__PURE__ */ jsx("input", {
                  type: "button",
                  value: "Remove from stream",
                  onClick: (e2) => {
                    projectCommands.removeRTMPSource(source2.id);
                  }
                }), /* @__PURE__ */ jsx("input", {
                  type: "button",
                  value: "Log renderer url",
                  onClick: async (e2) => {
                    const link = await studio.createPreviewLink({
                      projectId: project.id
                    });
...
//# sourceMappingURL=main.b783c554.js.map
