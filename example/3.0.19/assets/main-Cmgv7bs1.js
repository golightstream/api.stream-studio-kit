import { r as reactDomExports, g as getDefaultExportFromCjs, R as React, a as reactExports, j as jsx, i as index$1, b as init, c as jsxs, S as Style$1, d as config, P as Participants, D as DeviceSelection, C as ControlPanel, e as Chat, u as url, A as AppProvider } from "./index-Ds99uVe4.js";
var createRoot;
  ...
  React.useEffect(() => {
    return project.subscribe((event, payload) => {
      ...
      if (event === "ProjectSourceAdded") {
        ...
        if (((_b = (_a = source.address) == null ? void 0 : _a.dynamic) == null ? void 0 : _b.id) === "integration") {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx(MediaHeader, {
            ...
            children: sources.filter((source) => {
              var _a, _b;
              return ((_b = (_a = source.address) == null ? void 0 : _a.dynamic) == null ? void 0 : _b.id) === "integration";
            }).map((source) => {
              var _a, _b, _c, _d;
              return /* @__PURE__ */ jsxs("div", {
                children: [/* @__PURE__ */ jsxs("div", {
...
//# sourceMappingURL=main-Cmgv7bs1.js.map
